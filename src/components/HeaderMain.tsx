        ...
        <div className="flex flex-row gap-3 items-center">
          <div className="relative w-[99px] h-[34px] flex justify-end items-center">
            <input
              type="text"
              placeholder="Search"
              className="absolute right-0 top-0 w-[99px] focus:w-[330px] h-[34px] border border-accent-main bg-accent-bg rounded-[6px] px-2 py-[9px] transition-all duration-300 ease-in-out z-10 outline-none"
            />
            <SearchSVG className="absolute right-[10px] top-[8px] z-20" />
          </div>
          <button
            type="button"
            className="flex justify-center items-center w-[34px] h-[34px] bg-accent-main rounded-[6px] border border-accent-main"
          >
            <HeartSVG />
          </button>
          <button
